# 松田研究室 ロゴマーク・ロゴタイプについて

2024年1月1日　松田研ロゴ ver.0 使用開始  
2024年2月10日　、松田研ロゴver.1 使用開始

## 目次

#### ガイドライン
1. [カラーバリエーション](#カラーバリエーション)  
2. [クリアスペース（余白）](#クリアスペース)
3. [表示サイズ](#表示サイズ)
4. [カラーコード](#カラーコード)
5. [ファイルナンバー対応表](#ファイルナンバー対応表)  
...
松田研究室の頭文字である「M」の文字を基に、全体のシルエットは画像ファイルのアイコンを連想させるようシンプルにデザインされています。

![コンセプト01.PNG](https://dl.dropboxusercontent.com/scl/fi/4f5891uk9ea47fdqs1rit/01.png?rlkey=nl1wuxz468m50mpambgthnteu&dl=0)

また、左上の逆雫形は研究室として大切にしたい4つの価値を表しています。

![コンセプト02.PNG](https://dl.dropboxusercontent.com/scl/fi/far6ingsupsvetgxo5i6m/02.png?rlkey=nz2winh4msv3etfvkyhyclrq9&dl=0)

「気球」 ：　上昇  
上昇を象徴する気球の形は高みへの探求を表し、また、上空から街を眺めるように広い視野で物事を捉えることを表します。

「！」 ：　発見  
エクスクラメーションマークは研究過程での新たな発見を象徴し、日々の小さな気づきを大切にしていくことを表します。

「マップピン」 ：　目的地  
目的地を象徴するマップピンは、研究室の全員が目指す共通の目標を表します。

「吹き出し」 ：　発言   
コミュニケーションツールで用いられる吹き出しの形は、言葉が生まれる瞬間を象徴し、研究室内の対話や意見交換を表します。
